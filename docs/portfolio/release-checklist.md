...
| READY_FOR_GITHUB | CONDITIONAL | README is portfolio-ready, but public release should add demo media/link, keep the ROI-ablation blocker visible, and keep large runtime assets deliberate. |
